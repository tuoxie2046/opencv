...
set (IPP_ROOT_DIR "/opt/intel/ipp")
...
macro(ipp_detect_version)
  ...
  if(HAVE_IPP_ICV_ONLY)
    ...
    _ipp_add_library(cce9)
    _ipp_add_library(cck0)
    _ipp_add_library(ccl9)
    _ipp_add_library(ccm7)
    _ipp_add_library(ccmx)
    _ipp_add_library(ccn0)
    _ipp_add_library(ccn8)
    _ipp_add_library(cc)
    _ipp_add_library(ccy8)
    _ipp_add_library(che9)
    _ipp_add_library(chk0)
    _ipp_add_library(chl9)
    _ipp_add_library(chm7)
    _ipp_add_library(chmx)
    _ipp_add_library(chn0)
    _ipp_add_library(chn8)
    _ipp_add_library(ch)
    _ipp_add_library(chy8)
    _ipp_add_library(core)
    _ipp_add_library(cve9)
    _ipp_add_library(cvk0)
    _ipp_add_library(cvl9)
    _ipp_add_library(cvm7)
    _ipp_add_library(cvmx)
    _ipp_add_library(cvn0)
    _ipp_add_library(cvn8)
    _ipp_add_library(cv)
    _ipp_add_library(cvy8)
    _ipp_add_library(dce9)
    _ipp_add_library(dck0)
    _ipp_add_library(dcl9)
    _ipp_add_library(dcm7)
    _ipp_add_library(dcmx)
    _ipp_add_library(dcn0)
    _ipp_add_library(dcn8)
    _ipp_add_library(dc)
    _ipp_add_library(dcy8)
    _ipp_add_library(ie9)
    _ipp_add_library(ik0)
    _ipp_add_library(il9)
    _ipp_add_library(im7)
    _ipp_add_library(imx)
    _ipp_add_library(in0)
    _ipp_add_library(in8)
    _ipp_add_library(i)
    _ipp_add_library(iy8)
    _ipp_add_library(se9)
    _ipp_add_library(sk0)
    _ipp_add_library(sl9)
    _ipp_add_library(sm7)
    _ipp_add_library(smx)
    _ipp_add_library(sn0)
    _ipp_add_library(sn8)
    _ipp_add_library(s)
    _ipp_add_library(sy8)
    _ipp_add_library(vme9)
    _ipp_add_library(vmk0)
    _ipp_add_library(vml9)
    _ipp_add_library(vmm7)
    _ipp_add_library(vmmx)
    _ipp_add_library(vmn0)
    _ipp_add_library(vmn8)
    _ipp_add_library(vm)
    _ipp_add_library(vmy8)
    #_ipp_add_library(m)
    ...
    if(UNIX)
      ...
      if(NOT APPLE)
        if(IPP_X64)
          message(${INTEL_COMPILER_LIBRARY_DIR})
          if(NOT EXISTS ${INTEL_COMPILER_LIBRARY_DIR}/intel64_lin)
